...
$cat = $_GET['cat'];
 ...
 {
    $image = "cardboard.jpg";
    $p="Redefine cardboard waste with ScrapQ! Get those cardboard boxes when ever required on our platform. Connect with us for reusing cardboard and be a part of the sustainable solution. Join ScrapQ today and get an easy accessible platform to fulfil the requirements!";
 }

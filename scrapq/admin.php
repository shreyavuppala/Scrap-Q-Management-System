            ...
            <h2>Booking List</h2>
             <table class="table">
                ...
                <tr>
                    ...
                    <button class="btn btn-danger" type="submit" style="display: <?php if($value['status']=='2' or $value['status']=='1') {} else {echo "none";}?>" name="reject">Reject</button>

  ...
  <div id="invoice" class="effect2">
    ...
    <div id="invoice-mid">   
      <div id="message">
        ...
        <p>An invoice with invoice number #<span id="invoice_num">tst-inv-<?= $inv;?></span> is created for <span id="supplier_name">SCRAP Q.</span> which is 100% matched with PO and is waiting for your approval.  </p>
      </div>
    ...
    <footer>
      <div id="legalcopy" class="clearfix">
        <p class="col-right">Our mailing address is:
            <span class="email"><a href="mailto:info@scrapq.com">info@scrapq.com</a></span>
        </p>
      </div>
    </footer>
  </div><!--End Invoice-->
